...
> **وضعیت فعلی:** فازهای ۰ تا ۳ تکمیل شده‌اند — زیرساخت، Design System، احراز هویت و RBAC.
> ورود با موبایل و OTP کار می‌کند و نقش‌ها enforce می‌شوند.
> ساختار آکادمی (رشته، تیم، مدرسه) از Phase 4 شروع می‌شود.
