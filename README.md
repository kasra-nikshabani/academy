...
> **وضعیت فعلی:** فازهای ۰ تا ۹ تکمیل شده‌اند.
> ورود با موبایل و OTP، نقش‌ها و مجوزها، ساختار آکادمی، افراد، ثبت‌نام و عضویت، مسیر بازیکن، تمرین، و **حضور و غیاب** —
> همراه با Scope کامل: مربی فقط بازیکنان و تقویم تیم‌های خودش، ولی فقط فرزندان خودش.
> استعدادیابی از Phase 10 شروع می‌شود.
