...
> **وضعیت فعلی:** فازهای ۰ تا ۷ تکمیل شده‌اند.
> ورود با موبایل و OTP، نقش‌ها و مجوزها، ساختار آکادمی، افراد، ثبت‌نام و عضویت، و **مسیر بازیکن** —
> همراه با Scope کامل: مربی فقط بازیکنان تیم‌های خودش، ولی فقط فرزندان خودش.
> تمرین و حضور و غیاب از Phase 8 شروع می‌شود.
