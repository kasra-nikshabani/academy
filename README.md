...
> **وضعیت فعلی:** فازهای ۰ تا ۴ تکمیل شده‌اند — زیرساخت، Design System، احراز هویت، RBAC و ساختار آکادمی.
> ورود با موبایل و OTP کار می‌کند، نقش‌ها enforce می‌شوند، و رشته‌ها/رده‌های سنی/فصل‌ها/مدارس/تیم‌ها قابل مدیریت‌اند.
> بازیکنان، اولیا و کادر فنی از Phase 5 شروع می‌شوند.
