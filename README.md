...
> **وضعیت فعلی:** فازهای ۰ تا ۵ تکمیل شده‌اند.
> ورود با موبایل و OTP، نقش‌ها و مجوزها، ساختار آکادمی، و بازیکنان/اولیا/کادر فنی همراه با
> **Scope کامل** — مربی فقط تیم‌های خودش، ولی فقط فرزندان خودش.
> ثبت‌نام مدرسه و عضویت تیم از Phase 6 شروع می‌شود.
