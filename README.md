...
> **وضعیت فعلی:** فازهای ۰ تا ۶ تکمیل شده‌اند.
> ورود با موبایل و OTP، نقش‌ها و مجوزها، ساختار آکادمی، افراد، و ثبت‌نام مدرسه و عضویت تیم —
> همراه با **Scope کامل**: مربی فقط بازیکنان تیم‌های خودش، ولی فقط فرزندان خودش.
> مسیر بازیکن (Player Journey) از Phase 7 شروع می‌شود.
