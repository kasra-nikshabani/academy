...
> **وضعیت فعلی:** فازهای ۰ تا ۱۰ تکمیل شده‌اند.
> ورود با موبایل و OTP، نقش‌ها و مجوزها، ساختار آکادمی، افراد، ثبت‌نام و عضویت، مسیر بازیکن، تمرین، حضور و غیاب، و **استعدادیابی** —
...
> موتور ارزیابی از Phase 11 شروع می‌شود.
